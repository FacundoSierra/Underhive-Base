...
public class Scene2 extends JDialog {
	...
	public void boton_Volver() {
		...
		boton_Volver.setIcon(new ImageIcon(Scene2.class.getResource("/gui/iconosManu/Salir.jpg")));
	...
	public void opcion_fps() {
		...
		Cuadro.setIcon(new ImageIcon(Scene2.class.getResource("/gui/iconosManu/cuadro3_MENUDEOPCIONES.png")));
