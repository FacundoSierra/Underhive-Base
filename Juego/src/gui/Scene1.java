...
public class Scene1 extends JFrame {
	...
	public void boton_Play() {
		...
		try {
			...
			botonPlay.setIcon(new ImageIcon(Scene1.class.getResource("/gui/iconosManu/play1.png")));
	...
	public void boton_Settings() {
		...
		try {
			contentPane.setLayout(null);
			botonSettings.setIcon(new ImageIcon(Scene1.class.getResource("/gui/iconosManu/Settings.png")));
	...
	public void boton_Salir() {
		...
		try {
			...
			botonSalir.setIcon(new ImageIcon(Scene1.class.getResource("/gui/iconosManu/Salir.jpg")));
	...
	public void marco() {
		...
		try {
			...
			marco.setIcon(new ImageIcon(Scene1.class.getResource("/gui/iconosManu/CUADRO_BUENO.png")));
